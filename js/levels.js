function setLevel(levelNumber = 1) {
    if (levelNumber === 1)
        return new Level(7, 9, 15, 10 , 4, 35000); // Easy TEST level // hens, chicks, coins, bottles, bg-lengths, max game time
    if (levelNumber === 2) 
        return new Level(13, 15, 20, 10, 6, 30000); // params: amounts of: hens, chicks, coins, bottles, bg-lengths, max game time
    if (levelNumber === 3)
       return new Level(19, 21, 25, 10, 8, 30000); // params: amounts of: hens, chicks, coins, bottles, bg-lengths, max game time
